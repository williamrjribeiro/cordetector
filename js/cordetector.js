...
var CoRDetector = function() {
	...
	var ChainLink =
	{
		...
		handleRequest: function(req)
		{
			...
			// only continue with the chain if there's a successor!
			...
			{
				console.debug("[ChainLink.handleRequest] end of chain. req: "+req);
				
				_print("End of chain. userAgent: "+req.userAgent);
			}
		}
	};
	...
	// call init function everytime the constructor is called
	_init();
